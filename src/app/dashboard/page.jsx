...
import ReadCustomer from "@/MainComponent/(SubComponents)/AdminComponent/ReadCustomer";
import ReadMeter from "@/MainComponent/(SubComponents)/AdminComponent/ReadMeter";
import ReadTariff from "@/MainComponent/(SubComponents)/AdminComponent/ReadTariff";
import ReadAccount from "@/MainComponent/(SubComponents)/AdminComponent/ReadAccount";
ChartJS.register(
  ArcElement,
  Tooltip,
  Legend,
    ...
    switch (activeContent) {
      ...
      case "meter":
        return (
          <div className="card mb-4">
            <div className="card-body">
              <h5 className="card-title">Add Meter</h5>
              <form>
                <div className="mb-3">
